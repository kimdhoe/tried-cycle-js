...
var render = function render(user) {
  return (0, _dom.div)([(0, _dom.button)('.get-random', 'Get random user'), user === null ? null : (0, _dom.div)('.user-details', [(0, _dom.h1)('.user-name', user.name), (0, _dom.h4)('.user-email', user.email), (0, _dom.a)('.user-website', { href: user.website }, user.website)])]);
};

var main = function main(sources) {
  var clickEv$ = sources.DOM.select('.get-random').events('click');

  var request$ = clickEv$.map(request);

  var response$$ = sources.HTTP.select('users');
  var response$ = response$$.flatten();
  var user$ = response$.map(function (response) {
...
},{"@cycle/dom":12,"@cycle/http":23,"@cycle/xstream-run":26,"xstream":128}],2:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":7,"./utils":20,"matches-selector":101}],4:[function(require,module,exports){
"use strict";
var ScopeChecker_1 = require('./ScopeChecker');
var utils_1 = require('./utils');
var matchesSelector;
...
},{"./ScopeChecker":7,"./utils":20,"matches-selector":101}],5:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":25,"xstream":128}],6:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"./ElementFinder":3,"./EventDelegator":4,"./fromEvent":9,"./isolate":13,"./utils":20,"@cycle/xstream-adapter":25,"matches-selector":101,"xstream":128}],7:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":11,"snabbdom-selector/lib/classNameFromVNode":102,"snabbdom-selector/lib/selectorParser":103}],9:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"./MainDOMSource":6,"./VNodeWrapper":8,"./isolateModule":14,"./modules":18,"./transposition":19,"./utils":20,"@cycle/xstream-adapter":25,"es6-map":70,"snabbdom":120,"xstream":128}],16:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"./HTMLSource":5,"./transposition":19,"@cycle/xstream-adapter":25,"snabbdom-to-html":105}],17:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":25,"xstream":128}],18:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":25,"xstream":128}],20:[function(require,module,exports){
"use strict";
...
},{"./isolate":24,"@cycle/xstream-adapter":25}],22:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"./MainHTTPSource":21,"@cycle/xstream-adapter":25,"superagent":123,"xstream":128}],23:[function(require,module,exports){
"use strict";
/**
 * HTTP Driver factory.
 *
...
},{"./http-driver":22}],24:[function(require,module,exports){
"use strict";
...
},{"@cycle/base":2,"@cycle/xstream-adapter":25}],27:[function(require,module,exports){
/*!
...
},{"lodash.isarguments":94,"lodash.isarray":95}],83:[function(require,module,exports){
/**
...
},{"lodash._baseindexof":84,"lodash._cacheindexof":87,"lodash._createcache":88}],86:[function(require,module,exports){
/**
...
},{"lodash._root":90}],92:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":90}],93:[function(require,module,exports){
/**
 * lodash 3.0.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._basefor":83,"lodash._bindcallback":86,"lodash.keys":97}],94:[function(require,module,exports){
/**
...
},{"lodash.deburr":91,"lodash.words":100}],97:[function(require,module,exports){
/**
 * lodash 3.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":89,"lodash.isarguments":94,"lodash.isarray":95}],98:[function(require,module,exports){
/**
...
},{"lodash._baseflatten":82,"lodash._baseuniq":85,"lodash.restparam":98}],100:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":90}],101:[function(require,module,exports){
'use strict';
...
},{"browser-split":27}],104:[function(require,module,exports){
...
},{"../parse-selector":109,"lodash.escape":92,"lodash.forown":93,"lodash.union":99}],108:[function(require,module,exports){
...
},{"lodash.escape":92,"lodash.forown":93,"lodash.kebabcase":96}],109:[function(require,module,exports){
...
},{"browser-split":27}],110:[function(require,module,exports){
...
},{"./is-object":124,"./request":126,"./request-base":125,"emitter":28}],124:[function(require,module,exports){
/**
