...
var intent = function intent(sources) {
  return sources.events('click');
};

var model = function model(reset$) {
  return reset$.startWith(null).map(function () {
    return _xstream2.default.periodic(1000);
  }).flatten();
};

var main = function main(sources) {
  var reset$ = intent(sources.DOM.select('.seconds'));
  var second$ = model(reset$);
  var vdom$ = second$.map(function (i) {
    return (0, _dom.div)('.seconds', [(0, _dom.p)('Seconds elapsed: ' + i)]);
  });
...
var drivers = { DOM: (0, _dom.makeDOMDriver)('#app') };

(0, _xstreamRun.run)(main, drivers);

},{"@cycle/dom":12,"@cycle/xstream-run":22,"xstream":119}],2:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":7,"./utils":20,"matches-selector":96}],4:[function(require,module,exports){
"use strict";
var ScopeChecker_1 = require('./ScopeChecker');
var utils_1 = require('./utils');
var matchesSelector;
...
},{"./ScopeChecker":7,"./utils":20,"matches-selector":96}],5:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":21,"xstream":119}],6:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"./ElementFinder":3,"./EventDelegator":4,"./fromEvent":9,"./isolate":13,"./utils":20,"@cycle/xstream-adapter":21,"matches-selector":96,"xstream":119}],7:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":11,"snabbdom-selector/lib/classNameFromVNode":97,"snabbdom-selector/lib/selectorParser":98}],9:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"xstream":119}],10:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"snabbdom/is":108,"snabbdom/vnode":117}],12:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":11,"./hyperscript-helpers":10,"./makeDOMDriver":15,"./makeHTMLDriver":16,"./mockDOMSource":17,"snabbdom/thunk":116}],13:[function(require,module,exports){
"use strict";
var utils_1 = require('./utils');
...
},{"./MainDOMSource":6,"./VNodeWrapper":8,"./isolateModule":14,"./modules":18,"./transposition":19,"./utils":20,"@cycle/xstream-adapter":21,"es6-map":65,"snabbdom":115,"xstream":119}],16:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"./HTMLSource":5,"./transposition":19,"@cycle/xstream-adapter":21,"snabbdom-to-html":100}],17:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":21,"xstream":119}],18:[function(require,module,exports){
"use strict";
...
},{"snabbdom/modules/attributes":109,"snabbdom/modules/class":110,"snabbdom/modules/eventlisteners":111,"snabbdom/modules/hero":112,"snabbdom/modules/props":113,"snabbdom/modules/style":114}],19:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":21,"xstream":119}],20:[function(require,module,exports){
"use strict";
...
},{"xstream":119}],22:[function(require,module,exports){
"use strict";
...
},{"lodash.isarguments":89,"lodash.isarray":90}],78:[function(require,module,exports){
/**
...
},{"lodash._baseindexof":79,"lodash._cacheindexof":82,"lodash._createcache":83}],81:[function(require,module,exports){
/**
...
},{"lodash._getnative":84}],84:[function(require,module,exports){
/**
...
},{"lodash._root":85}],87:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":85}],88:[function(require,module,exports){
/**
 * lodash 3.0.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._basefor":78,"lodash._bindcallback":81,"lodash.keys":92}],89:[function(require,module,exports){
/**
...
},{"lodash.deburr":86,"lodash.words":95}],92:[function(require,module,exports){
/**
 * lodash 3.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":84,"lodash.isarguments":89,"lodash.isarray":90}],93:[function(require,module,exports){
/**
...
},{"lodash._baseflatten":77,"lodash._baseuniq":80,"lodash.restparam":93}],95:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":85}],96:[function(require,module,exports){
'use strict';
...
},{"./selectorParser":98}],98:[function(require,module,exports){
'use strict';
...
},{"browser-split":23}],99:[function(require,module,exports){
...
},{"./init":101,"./modules/attributes":102,"./modules/style":103}],101:[function(require,module,exports){
...
},{"./container-elements":99,"./parse-selector":104,"./void-elements":105}],102:[function(require,module,exports){
...
},{"../parse-selector":104,"lodash.escape":87,"lodash.forown":88,"lodash.union":94}],103:[function(require,module,exports){
...
},{"lodash.escape":87,"lodash.forown":88,"lodash.kebabcase":91}],104:[function(require,module,exports){
...
},{"browser-split":23}],105:[function(require,module,exports){
...
},{"../is":108}],112:[function(require,module,exports){
...
},{"./htmldomapi":107,"./is":108,"./vnode":117}],116:[function(require,module,exports){
var h = require('./h');
...
},{"./h":106}],117:[function(require,module,exports){
