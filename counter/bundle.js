...
var render = function render(num) {
  return (0, _dom.div)([(0, _dom.button)('.dec', 'Decrement'), (0, _dom.button)('.inc', 'Increment'), (0, _dom.p)('Counter: ' + num)]);
};
...
var main = function main(sources) {
  ...
  var decAction$ = decClick.mapTo(-1);
  var incAction$ = incClick.mapTo(+1);

  var action$ = _xstream2.default.merge(decAction$, incAction$);

  var count$ = action$.fold(function (acc, x) {
    return acc + x;
  }, 0);

  var vdom$ = count$.map(render);
